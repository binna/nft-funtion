...
tmp_json = nft("0x4007cb1fb9d1158add29cf5d88568dd44a1f516e", "")
...
while True:
    tmp_json = nft("0x4007cb1fb9d1158add29cf5d88568dd44a1f516e", cursor)
    json += (tmp_json.get("items"))
    cursor = tmp_json.get("cursor")
    if cursor == "":
        break
...
writer = pd.ExcelWriter('treasures_club.xlsx', engine='xlsxwriter')
